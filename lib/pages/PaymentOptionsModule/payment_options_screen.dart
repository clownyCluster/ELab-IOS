...
class PaymentOptionsScreen extends StatelessWidget {
  ...
  static const String id = 'PaymentOptionsScreen';

  @override
  Widget build(BuildContext context) {
    final state = Provider.of<PaymentOptionsState>(context);
    return Scaffold(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        maxWidthSpan(),
                                        Text(
                                          'Rs.${state.cartListResponse!.totalPrice! + state.cartListResponse!.couponPrice!}',
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    //         activeColor: primaryColor,
                                    //         shape: CircleBorder(),
                                    //         value: state.isCart == true,
                                    //         onChanged: state.onCartChange),
                                    //     Text('Debit / Credit Cart'),
                                    //   ],
                                    // ),
                                    // Row(
                                    //   children: [
                                    ...
                                    //         activeColor: primaryColor,
                                    //         shape: CircleBorder(),
                                    //         value: state.isEsewa == true,
                                    //         onChanged: state.onEsewaChange),
                                    //     Text('E - Sewa'),
                                    //   ],
                                    // ),
                                    // Row(
                                    ...
                                    //         activeColor: primaryColor,
                                    //         shape: CircleBorder(),
                                    //         value: state.isKhalti,
                                    //         onChanged: state.onKhaltiChange),
                                    //     Text('Khalti'),
                                    //   ],
                                    // ),
                                  ],
